 ...
 */
public class Flzl1Handler implements GSModuleBase<GSSiteHandler> {
...
//		System.out.println(zzsListHtml);
	...
	private Map<String,Object> parseLssb(Element tr){
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("10004001", StringUtils.StringFormat(tr.child(2).child(0).text()));
		map.put("10004002",StringUtils.StringFormat( tr.child(3).child(0).text()));
		map.put("10004003", StringUtils.StringFormat(tr.child(4).child(0).text()));
