...
public class GsAction extends HttpServlet{
	...
	@ResponseBody
		public List<Document> getData(@RequestParam String companyId,@RequestParam String type) {
		return companyDataDao.getDataByType(companyId,type);
	}
}
