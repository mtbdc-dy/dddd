...
public class LandGrabSyfdcqyxxb {
	public String selectLandTaxByDate(String time1,String time2){
		...
		response = TaxConstants.getMes(httpclient, "http://www.zjds-etax.cn/wsbs/api/main/sybb/syqy?qsny="+time1+"&sybbDm=SY04&zzny="+time2,userId);
